...
formatData = ({UNIQUE_ID, POINT_X, POINT_Y, ROUTE_NAM, LENGTH}) => ({
    latitude: utmToLatLng(10, POINT_X, POINT_Y, true)["latitude"],
    longitude: utmToLatLng(10, POINT_X, POINT_Y, true)["longitude"],
...
const newData = data.reduce((accumulator, element) => {
  accumulator.push(formatData(element));
  return accumulator;
}, []);
