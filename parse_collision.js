...
const fs = require('fs');
const data = require('./collision_non_fatalities.json');
...
formatData = ({CoV_ID, Latitude, Longitude}) => ({
  "type": "Feature",
  "properties": {
    "name": `${CoV_ID}`,
  },
...
fs.writeFile("collision_non_fatalities_transformed.json", JSON.stringify(newData), () => {});
